...
.cont_ft h3 span{}
.cont_ft .gw{ width:80%; overflow:hidden; margin:0 auto;background-image:url(${pageContext.request.contextPath}/diveshare/btn_1.png);}
...
<body>
	 <div class="cont_ft">
   		<h3><img src="${pageContext.request.contextPath}/diveshare/logo.png" alt=""> </h3>
       	<div class="gw"><a href="${pageContext.request.contextPath}/" style="font: inherit;">进入潜程官网下载APP</a></div>
