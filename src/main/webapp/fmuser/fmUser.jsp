			...
			<form id="searchForm">
				<table class="table table-hover table-condensed" style="display: none;">
						<tr>	
							...
							<td>
								<input type="text" class="span2" onclick="WdatePicker({dateFmt:'<%=TfmUser.FORMAT_ADDTIME%>'})" id="addtimeBegin" name="addtimeBegin"/>
								<input type="text" class="span2" onclick="WdatePicker({dateFmt:'<%=TfmUser.FORMAT_ADDTIME%>'})" id="addtimeEnd" name="addtimeEnd"/>
							</td>
							<th><%=TfmUser.ALIAS_UPDATETIME%></th>	
							<td>
								<input type="text" class="span2" onclick="WdatePicker({dateFmt:'<%=TfmUser.FORMAT_UPDATETIME%>'})" id="updatetimeBegin" name="updatetimeBegin"/>
								<input type="text" class="span2" onclick="WdatePicker({dateFmt:'<%=TfmUser.FORMAT_UPDATETIME%>'})" id="updatetimeEnd" name="updatetimeEnd"/>
							</td>
							...
							<td>
											<input type="text" name="account" maxlength="100" class="span2"/>
							</td>
						</tr>	
						<tr>	
							...
							<td>
											<input type="text" name="localArea" maxlength="36" class="span2"/>
							</td>
						...
						<tr>	
							...
							<td>
											<input type="text" name="realName" maxlength="20" class="span2"/>
							</td>
							<th><%=TfmUser.ALIAS_CARD_ID%></th>	
							<td>
											<input type="text" name="cardId" maxlength="20" class="span2"/>
							</td>
							...
							<td>
											<input type="text" name="hxPassword" maxlength="36" class="span2"/>
							</td>
						</tr>	
						<tr>	
