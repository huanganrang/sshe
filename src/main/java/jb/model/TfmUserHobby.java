...
@Entity
@Table(name = "fm_user_hobby")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TfmUserHobby implements java.io.Serializable,IEntity{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "FmUserHobby";
	...
	public boolean equals(Object obj) {
		if(obj instanceof FmUserHobby == false) return false;
		if(this == obj) return true;
		FmUserHobby other = (FmUserHobby)obj;
