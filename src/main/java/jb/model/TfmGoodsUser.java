...
@Entity
@Table(name = "fm_goods_user")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TfmGoodsUser implements java.io.Serializable,IEntity{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "FmGoodsUser";
	...
	public boolean equals(Object obj) {
		if(obj instanceof FmGoodsUser == false) return false;
		if(this == obj) return true;
		FmGoodsUser other = (FmGoodsUser)obj;
